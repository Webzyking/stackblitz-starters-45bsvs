    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Modern e-commerce platform offering premium products at competitive prices.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <form className="mt-4">
              ...
              />
              <button className="mt-2 w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                Subscribe
              </button>
            </form>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>© 2023 Modern E-commerce. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
